...
const IDS = [
  ...
  'stage-0', 'stage-1', 'stage-2', 'stage-3', 'app', 'cors-proxy',
  'seam-modal', 'seam-modal-backdrop', 'seam-modal-close', 'seam-modal-canvas',
  'seam-modal-graph-canvas', 'seam-modal-readout', 'seam-modal-header-title',
  'cell-tooltip',
];
